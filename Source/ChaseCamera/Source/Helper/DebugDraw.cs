...
namespace ChaseCameraSample
{
    ...
    public class DebugDraw : IDisposable
    {
        ...
        public void DrawWireSphere(BoundingSphere sphere, Color color)
        {
            ...
            DrawRing(sphere.Center, view.Up * sphere.Radius, view.Forward * sphere.Radius, color);
            DrawRing(sphere.Center, view.Forward * sphere.Radius, view.Right * sphere.Radius, color);
        }
